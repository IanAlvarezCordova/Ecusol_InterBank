        ...
        <div className="min-h-screen bg-gray-100 font-sans text-gray-800 pb-20">
            ...
            <main className="max-w-7xl mx-auto p-6 space-y-6">
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex gap-4">
                    ...
                    <button onClick={handleBuscar} disabled={loadingBusqueda || !busqueda} className="bg-ecusol-primario text-white px-6 rounded-lg font-bold hover:bg-blue-900 disabled:opacity-50 min-w-[100px] flex justify-center items-center">
                            ...
                            <div className="space-y-3">
                                ...
                                {resumenCliente.cuentas.map((cuenta) => {
                                    ...
                                    return (
                                        ...
                                        ${cuentaActiva?.numeroCuenta === cuenta.numeroCuenta ? 'border-ecusol-primario bg-blue-50 ring-1 ring-ecusol-primario' : 'border-gray-200 bg-white hover:border-blue-300'}
                                ...
                                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden h-full flex flex-col">
                                    ...
                                    {!cuentaEsActiva ? (
                                        <div className="flex-1 flex flex-col items-center justify-center p-10 text-center">
                                            ...
                                            <button onClick={activarCuenta} disabled={procesando} className="bg-ecusol-primario text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-900 flex items-center gap-2 shadow-lg">
                                        ...
                                        <>
                                            <div className="flex border-b">
                                                {['DEPOSITO', 'RETIRO', 'TRANSFERENCIA'].map((t) => (
                                                    <button key={t} onClick={() => setTab(t as any)} className={`flex-1 py-4 font-bold text-sm border-b-4 transition-all ${tab === t ? 'border-ecusol-primario text-ecusol-primario bg-blue-50/30' : 'border-transparent text-gray-400 hover:bg-gray-50'}`}>{t}</button>
                                                ))}
                                            </div>
                                            <div className="p-8 flex-1">
                                                <form onSubmit={handleOperar} className="max-w-md mx-auto space-y-6">
                                                    ...
                                                    <button type="submit" disabled={procesando} className="w-full py-4 bg-ecusol-primario text-white rounded-xl font-bold shadow-lg hover:bg-blue-900 transition-all flex justify-center items-center gap-2 disabled:opacity-50">
