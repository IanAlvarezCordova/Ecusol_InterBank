...
const LoginEmpleado = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-100 font-sans">
      {/* Izquierda */}
      <div className="hidden lg:flex w-1/2 bg-ecusol-primario items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center z-10 text-white p-12">
          ...
          <p className="text-ecusol-secundario font-medium text-xl">Sistema Interno Banco Ecusol</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md bg-white p-10 rounded-3xl shadow-2xl">
          <div className="flex flex-col items-center mb-8">
            <LogoEcusol size={70} className="mb-4" />
