...
const StatItem: React.FC<{ valor: string, etiqueta: string }> = ({ valor, etiqueta }) => (
  <div className="text-center">
    <p className="text-4xl font-bold text-ecusol-primario">{valor}</p>
      ...
      <div className="container mx-auto px-6">
        ...
        <Tarjeta className="max-w-4xl mx-auto bg-ecusol-gris-claro">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <Phone size={36} className="mx-auto text-ecusol-primario mb-3" />
            ...
            <div>
              <Mail size={36} className="mx-auto text-ecusol-primario mb-3" />
            ...
            <div>
              <MessageCircle size={36} className="mx-auto text-ecusol-primario mb-3" />
