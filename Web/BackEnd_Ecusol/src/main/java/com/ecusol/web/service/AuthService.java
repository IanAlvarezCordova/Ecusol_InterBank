...
public class AuthService {
    ...
    @Autowired
    private CoreBancarioClient coreBancarioClient; // Inyectar
    ...
    public String login(LoginRequest req) {
        ...
        try {
            ...
            // throw new RuntimeException("SU CLIENTE BANCARIO ESTÁ INACTIVO/BLOQUEADO. Por
            // favor acérquese a una agencia.");
            // }
        } catch (Exception e) {
