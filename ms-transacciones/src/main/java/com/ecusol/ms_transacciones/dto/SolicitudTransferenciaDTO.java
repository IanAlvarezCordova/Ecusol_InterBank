...
public class SolicitudTransferenciaDTO {
    ...
    @Schema(description = "Código del banco destino para DIGICONECU (ej: BANTEC, ARCBANK, ECUSOL)", example = "BANTEC")
    private String bancoDestinoCodigo;

    @Schema(description = "(Legacy) ID numérico del banco destino. 2=ECUSOL/NEXUS (interno), otro=externo", example = "1")
    ...
    public boolean esTransferenciaInterna() {
        ...
        // 2. bancoDestinoCodigo es ECUSOL
        // 3. bancoDestinoId es 2 (código interno para ECUSOL/NEXUS)
